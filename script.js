...
const correctRiddleAnswer2 = ["TIDUR,'NONTON FILM"]; 
...
window.checkAnswer1 = function() {
    ...
    if (answer === correctRiddleAnswer) {
        message.innerText = "Yey! Betull! Ternyata masih ingat aku Siapa wkwk. Lanjut ke pertanyaan kedua ya!"; 
...
window.checkAnswer2 = function() {
    ...
    if (correctRiddleAnswer2.includes(answer)) {
        ...
        message.innerText = "Salah! Coba ketik nama kampusnya (Ketiknya IPB atau UPI aja Ya)"; 
        message.style.color = 'Red';
        input.classList.add('lockshake');
